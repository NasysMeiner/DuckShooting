...
public class WaveSpawner : MonoBehaviour
{
    ...
    private IEnumerator SpawnEnemyInWave()
    {
        if(_enemiesLeftToSpawn > 0)
        {
            ...
            Instantiate(_waves[_currentWaveIndex].WaveSettings[_currentEnemyIndex].Enemy,_waves[_currentWaveIndex].
                WaveSettings[_currentEnemyIndex].NeededSpawner.transform.position, Quaternion.identity);
            _enemiesLeftToSpawn--;
            _currentEnemyIndex++;
